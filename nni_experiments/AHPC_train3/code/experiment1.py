...
def main():
    ...
    dataset = WisdmDatasetParser(f'{Path.home()}/snntorch_network/data/{DATASET_NAME}', norm=None)
    ...
    net = QuantAhpcNetwork(NET_INPUT_DIM, int(params['net_hidden_1']), int(params['net_hidden_2']),
                      NET_OUTPUT_DIM, params['beta'],grad, params['threshold'], back_beta=params['back_beta'], time_dim=2).to(device)
