...
def main():
    ...
    net = QuantAhpcNetwork(NET_INPUT_DIM, int(params['net_hidden_1']), int(params['net_hidden_2']), NET_OUTPUT_DIM, grad,
                        ...
                        drop_recurrent=params['drop_recurrent'], drop_back=params['drop_back'], drop_out=params['drop_out'],
                        encoder_dim=int(params['encoder_dim']), vth_enc_value=params['vth_enc_value'], vth_std=params['vth_std'],beta_std=params['beta_std'],
